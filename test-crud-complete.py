...
class OdowellTester:
    ...
    def test_crud_appointments(self) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                response_data = response.json()
                created = response_data.get("appointment", response_data)
        ...
        try:
            ...
            if response.status_code == 200:
                response_data = response.json()
                updated = response_data.get("appointment", response_data)
        ...
        try:
            ...
            if response.status_code == 200:
                response_data = response.json()
                appointment = response_data.get("appointment", response_data)
    ...
    def test_crud_budgets(self) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                response_data = response.json()
                created = response_data.get("budget", response_data)
        ...
        try:
            ...
            if response.status_code == 200:
                response_data = response.json()
                updated = response_data.get("budget", response_data)
